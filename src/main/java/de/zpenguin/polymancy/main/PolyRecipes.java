...
public class PolyRecipes {
	...
	public static void registerRecipes(Register<IRecipe> r) {
        ...
        addInfusionRecipe("ROD_INFERNAL.1", "ROD_INFERNAL@2", new ItemStack(PolyItems.itemWandRod, 1, 0), 3, new ItemStack(TW_Items.itemWandRod, 1, 2), aspects, new ItemStack(Blocks.NETHERRACK), new ItemStack(Items.NETHER_WART), new ItemStack(Items.NETHER_WART), new ItemStack(Items.SKULL,1,1), new ItemStack(Items.NETHER_STAR));

        aspects = new AspectList().add(Aspect.DARKNESS, 50).add(Aspect.ELDRITCH, 20).add(Aspect.AIR, 20);
        addInfusionRecipe("ROD_CHORUS.1", "ROD_CHORUS@2", new ItemStack(PolyItems.itemWandRod, 1, 1), 3, new ItemStack(TW_Items.itemWandRod, 1, 4), aspects, new ItemStack(Blocks.END_STONE), new ItemStack(Items.CHORUS_FRUIT_POPPED), new ItemStack(Items.CHORUS_FRUIT_POPPED), new ItemStack(Items.ENDER_EYE), new ItemStack(Blocks.DRAGON_EGG));
    ...
    public static void addShapedOreRecipe(String name,ItemStack output, Object... params) {
        ResourceLocation location = new ResourceLocation(Polymancy.modID, name);
